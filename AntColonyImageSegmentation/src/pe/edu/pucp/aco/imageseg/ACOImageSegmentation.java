package pe.edu.pucp.aco.imageseg;
...
import pe.edu.pucp.aco.imageseg.config.ProblemConfiguration;
import pe.edu.pucp.ia.aco.Ant;
import pe.edu.pucp.ia.aco.ImagePixel;
	...
	private int[][] normalizePheromoneMatrix() {
		...
		for (int i = 0; i < numberOfRows; i++) {
			for (int j = 0; j < numberOfColumns; j++) {
				...
				// System.out.println("i: " + i + ", j: " + j + ", greyscale: "
				// + normalizedPheromoneMatrix[i][j]);
			}
		}
